...
from .noise_multi_validation import noise_slide_window
    ...
    def __call__(
        ...
        if init_noise == "rand_all":
            if generator is None:
                ...
                # Initialize the noise by sliding window
                B_noise_group, I_noise_group = noise_slide_window(
                    total_w=w_bi, 
                    total_impact=impact, 
                    h=latents.shape[2], 
                    w=latents.shape[3], 
                ...
                latents = B_noise_group * (1 - latents_mask) + I_noise_group * latents_mask
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                if double_cfg_inference and do_classifier_free_guidance:
                    ...
                    # Parallel denoising via two unet
                    ...
                    unet_out_uncond = unet_out_uncond * rearrange((1-latents_mask), "a b ... -> (a b) ...") \
                        + unet_out_uncond_I * rearrange(latents_mask, "a b ... -> (a b) ...")
                    unet_out_cond = unet_out_cond * rearrange((1-latents_mask), "a b ... -> (a b) ...") \
                        + unet_out_cond_I * rearrange(latents_mask, "a b ... -> (a b) ...")
