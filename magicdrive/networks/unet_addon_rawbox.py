...
class BEVControlNetModel(ModelMixin, ConfigMixin):
    ...
    def forward(
        ...
        **kwargs,
        ...
        # controlnet_cond = F.interpolate(controlnet_cond, size=(14, 25), mode='bilinear', align_corners=False)
        if sample.shape[2] != controlnet_cond.shape[2]:
            controlnet_cond=controlnet_cond.resize_(controlnet_cond.shape[0], 320, 7, 10)
