...
def create_nuscenes_infos(
    ...
    for k in tqdm(range(1400,1409)):
        my_sample = nusc.sample[k]  
        ann_list = my_sample['anns'] 
        imgs = []
        for index,cam_type in enumerate(camera_types):
            sample_data_token = my_sample['data'][cam_type]
